...
<div className='grid gap-4 about-page-pic-wrapper sm:flex-col sm:items-center'>
	<div className='flex-col sm:flex sm:shadow-background gap-8 justify-center'>
        <Image
            alt="UCI Portal"
            className="w-10/12 sm:w-2/5"
            fill={true}
            height="600"
            width="600"
