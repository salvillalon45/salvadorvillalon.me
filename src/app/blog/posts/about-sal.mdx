...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/posts/about_sal/acceptance_letter/uci_portal.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/posts/about_sal/acceptance_letter/uci_acceptance.png"
        />
    </div>
    <p>My UCI Acceptance letter back in 2015</p>
</div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/posts/about_sal/tennis_pics/tennis1.jpeg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/posts/about_sal/tennis_pics/tennis2.jpg"
        />
    </div>
    <p>Senior Year High School - I was #1 Doubles! That year I went to CIF!</p>
</div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/posts/about_sal/aip/aip_intern_team.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/posts/about_sal/aip/aip_solo.jpg"
        />
    </div>
    <p>Sophomore Year at AIP. Manager in the middle. Teammate on the right side!</p>
</div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/posts/about_sal/aip/karate_kid.gif"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/posts/about_sal/aip/steve.jpg"
        />
    </div>
    <p>Steve and I at a Student Conference!</p>
</div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/posts/about_sal/from_here_and_out/ny/solo.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/posts/about_sal/from_here_and_out/ny/group_pic.jpg"
        />
    </div>
    <p>S&P Dow Jones Indices Internship in New York! First in my family to explore New York.</p>
</div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/posts/about_sal/from_here_and_out/chicago/solo.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/posts/about_sal/from_here_and_out/chicago/group_pic.jpeg"
        />
    </div>
    <p>JP Morgan Chase & Co in Chicago! First in my family to explore Chicago.</p>
</div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/posts/about_sal/from_here_and_out/shpe/group_trophy.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/posts/about_sal/from_here_and_out/shpe/board_members.jpg"
        />
    </div>
    <p>National Convention 2020 (Left). SHPE-UCI 2018-2019 board members (Right). SHPE-UCI played a big part of my life.</p>
</div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="600"
            width="600"
            src="/posts/about_sal/from_here_and_out/grad/squat.jpg"
        />
        <Image
            alt="UCI Portal"
            height="600"
            width="600"
            src="/posts/about_sal/from_here_and_out/grad/sitting.jpg"
        />
    </div>
