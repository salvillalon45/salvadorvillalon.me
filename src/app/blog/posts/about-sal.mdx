...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/about_sal/acceptance_letter/uci_portal.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/about_sal/acceptance_letter/uci_acceptance.png"
        />
    </div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/about_sal/tennis_pics/tennis1.jpeg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/about_sal/tennis_pics/tennis2.jpg"
        />
    </div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/about_sal/aip/aip_intern_team.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/about_sal/aip/aip_solo.jpg"
        />
    </div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/about_sal/aip/karate_kid.gif"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/about_sal/aip/steve.jpg"
        />
    </div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/about_sal/from_here_and_out/ny/solo.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/about_sal/from_here_and_out/ny/group_pic.jpg"
        />
    </div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/about_sal/from_here_and_out/chicago/solo.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/about_sal/from_here_and_out/chicago/group_pic.jpeg"
        />
    </div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="800"
            width="600"
            src="/about_sal/from_here_and_out/shpe/group_trophy.jpg"
        />
        <Image
            alt="UCI Portal"
            height="800"
            width="600"
            src="/about_sal/from_here_and_out/shpe/board_members.jpg"
        />
    </div>
...
<div className='about-page-pic-wrapper'>
    <div className='about-page-pics'>
        <Image
            ...
            height="600"
            width="600"
            src="/about_sal/from_here_and_out/grad/squat.jpg"
        />
        <Image
            alt="UCI Portal"
            height="600"
            width="600"
            src="/about_sal/from_here_and_out/grad/sitting.jpg"
        />
    </div>
